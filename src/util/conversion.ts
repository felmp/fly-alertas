export const converter = [
  { affiliateProgram: 'SMILES', price: 21.0 },
  { affiliateProgram: 'LATAM PASS', price: 32.50 },
  { affiliateProgram: 'LATAMPASS', price: 32.50 },
  { affiliateProgram: 'LATAM PASS - TABELA FIXA', price: 32.50 },
